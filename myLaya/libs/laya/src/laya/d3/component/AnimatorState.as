package laya.d3.component {
	...
	public class AnimatorState implements IReferenceCounter,IClone {
		 ...
		 * @return 脚本。
		 */
		public function addScript(type:AnimatorStateScript):AnimatorStateScript{
			return null;
		}
		 ...
		 * @return 脚本。
		 */
		public function getScript(type:AnimatorStateScript):AnimatorStateScript{
			return null;
		}
		 ...
		 * @return 脚本集合。
		 */
		public function getScripts(type:AnimatorStateScript):Array{
			return null;
		}
