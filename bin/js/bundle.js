...
class Main {
    constructor() {
        ...
        _pureMvc_core_GM__WEBPACK_IMPORTED_MODULE_6__["default"].getInstance().setupMgr.setupPlugins();
        _PlatFormMgr__WEBPACK_IMPORTED_MODULE_5__["default"].inst.init();
        _PlatFormMgr__WEBPACK_IMPORTED_MODULE_5__["default"].inst.mPlatAdReady = false;
        this.initFont();
    }
    onVersionLoaded() {
...
*  loading
*/
class LoadingPlugin extends _pureMvc_core_Moudle__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
        super([_ResGroup__WEBPACK_IMPORTED_MODULE_2__["default"].Loading]);
    }
    override_registerPureMvcAndStart() {
        this.super_registerMediator(new _view_LoadingMediator__WEBPACK_IMPORTED_MODULE_1__["default"]());
    }
}
...
class SetupManager {
    ...
    * */
    setupPlugins() {
        _MoudleManager__WEBPACK_IMPORTED_MODULE_1__["default"].inst.registerModule(_ModuleName__WEBPACK_IMPORTED_MODULE_2__["default"].LAOGING, _app_moudles_loading_LoadingPlugin__WEBPACK_IMPORTED_MODULE_0__["LoadingPlugin"]);
    }
    setup(s, fa) {
    }
    start() {
